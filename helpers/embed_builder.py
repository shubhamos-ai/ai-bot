...
class EmbedBuilder:
    ...
    def __init__(self, event: str) -> None:
        embeds = {
            ...
            # New user management action embeds
            "user_manage": discord.Embed(title="User Management", description="User moderation action", color=0x5865F2),
            "text_mute": discord.Embed(title="Text Muted", description="A user was text muted", color=0xff8000),
            "text_unmute": discord.Embed(title="Text Unmuted", description="A user was text unmuted", color=0x00ff00),
            "voice_mute": discord.Embed(title="Voice Muted", description="A user was voice muted", color=0xff8000),
            "voice_unmute": discord.Embed(title="Voice Unmuted", description="A user was voice unmuted", color=0x00ff00),
            "timeout": discord.Embed(title="Timeout", description="A user was timed out", color=0xff8000),
            "timeout_remove": discord.Embed(title="Timeout Removed", description="A user's timeout was removed", color=0x00ff00)
        }
